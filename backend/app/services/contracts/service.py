...
def accept_postulation(db: Session, request_id: str, current_user_id: str):
    ...
    try:
        ...
        # Cerrar chats de los otros postulantes
        ...
        # Reactivar o crear el chat del seleccionado
        try:
...
def complete_job(db: Session, job_id: str, user_id: str):
    ...
    if is_worker:
        ...
        # Si hay una disputa activa, no iniciar el timer de auto-liberación
        has_dispute = False
        ...
        # Cerrar el chat del trabajador contratado
        if job.request:
            try:
