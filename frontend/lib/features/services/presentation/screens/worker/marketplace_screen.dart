...
class MarketplaceScreen extends ConsumerWidget {
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 20),
                  _buildCategoryList(ref, topCategoriesAsync,
                      allCategoriesAsync, selectedCatId),
                ],
              ),
            ),
  ...
  Widget _buildSectionHeader(WidgetRef ref) {
    return Padding(
      ...
      child: Row(
        ...
        children: [
          const Text("Trabajos Disponibles",
  ...
  Widget _buildCategoryList(WidgetRef ref, AsyncValue topCats,
      AsyncValue allCats, String? selectedId) {
    return topCats.when(
          ...
          children: [
            ...
            allCats.maybeWhen(
              data: (list) => _buildCategoryChip(
                ...
                onTap: () =>
                    _showAllCategoriesModal(ref.context, list, ref, selectedId),
              ),
  ...
  Widget _buildWorkerHeader(String name) =>
      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
        Expanded(
          child:
            ...
            const Text("Encuentra tu próxima chamba 🛠️",
                style: TextStyle(
                    fontSize: 14,
